...
const authOptions = {
  ...
  // No custom "pages" override here — NextAuth's built-in sign-in page is used instead.
  // That page already lists your Google and Credentials (email/password) providers
  // automatically, so nothing else needs to change for login to work.
